...
<p align="center">
  <img src="docs/app_screen.png" width="85%">
</p>
<p align="center"><sub>회의 목록과 작업 영역. 상단 우측에 <b>외부 전송 없음 · 127.0.0.1</b> 상태를 항상 띄워, 녹음이 밖으로 나가지 않는다는 것을 쓰는 사람이 확인할 수 있게 했다.</sub></p>
